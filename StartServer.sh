...
start_server() {
    ...
    download "ViaVersion" "plugins/ViaVersion-4.8.1.jar" "https://github.com/ViaVersion/ViaVersion/releases/download/4.8.1/ViaVersion-4.8.1.jar"
    # ViaBackwards -> https://github.com/ViaVersion/ViaBackwards/
    download "ViaBackwards" "plugins/ViaBackwards-4.8.1.jar" "https://github.com/ViaVersion/ViaBackwards/releases/download/4.8.1/ViaBackwards-4.8.1.jar"
    # WorldEdit for Bukkit -> https://dev.bukkit.org/projects/worldedit/files/
    download "WorldEdit" "plugins/WorldEdit-7.2.17.jar" "https://mediafilez.forgecdn.net/files/4793/142/worldedit-bukkit-7.2.17.jar"
